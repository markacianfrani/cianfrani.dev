...
Writing Web Components is hard. Writing good Web Components is really hard. After spending the last year building out the [AstrouUXDS Web Components](https://www.astrouxds.com), I've learned a hard truth that a really good React/Vue/Angular/FoobarJS component does not make a really good web component. For those who are first jumping into the pool of Web Components, here is the guide that I wish I had one year ago. 
...
* ❌Requires developers to write more boilerplate
